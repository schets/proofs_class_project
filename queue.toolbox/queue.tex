...
\fl{}\moduleLeftDash\cl{ {\MODULE} queue}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers}
\fl{}
\fl{ BufSize \.{\defeq} 4}
\fl{}
\fl{ {\p@mmalgorithm} example}
 \fl{ {\p@variables} x \.{=} 5 ,\, buffer \.{=} [ i \.{\in} 1 \.{\dotdot}
 BufSize \.{\mapsto} \.{-} 1 ] ,\, write\_ind \.{=} 0 ,\, read\_ind \.{=} 0}
\fl{ {\p@begin}}
\fl{ Add\@s{.5}\textrm{:}\@s{3}}
\fl{ x \.{:=} x \.{+} 1 {\p@semicolon}}
...
\fl{}
\fl{ {\VARIABLES} x ,\, buffer ,\, write\_ind ,\, read\_ind ,\, pc}
\fl{}
 \fl{ vars}\al{14}{1}{ \.{\defeq} {\langle} x ,\, buffer ,\, write\_ind ,\,
 read\_ind ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{16}{1}{ \.{\defeq}}\al{16}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{17}{1}{ x \.{=} 5}
 \fl{ \.{\land}}\al{18}{1}{ buffer \.{=} [ i \.{\in} 1 \.{\dotdot} BufSize
 \.{\mapsto} 0 ]}
\fl{ \.{\land}}\al{19}{1}{ write\_ind \.{=} 0}
\fl{ \.{\land}}\al{20}{1}{ read\_ind \.{=} 0}
\fl{ \.{\land}}\al{21}{1}{ pc \.{=}\@w{Add}}
\fl{}
 \fl{ Add \.{\defeq}}\al{23}{2}{ \.{\land}}\al{23}{3}{ pc}\al{23}{4}{
 \.{=}}\al{23}{5}{\@w{Add}}
\fl{ \.{\land}}\al{24}{1}{ x \.{'}}\al{24}{3}{ \.{=}}\al{24}{4}{ x \.{+} 1}
\fl{ \.{\land}}\al{25}{1}{ pc \.{'} \.{=}\@w{Done}}
 \fl{ \.{\land}}\al{26}{1}{ {\UNCHANGED} {\langle} buffer ,\, write\_ind ,\,
 read\_ind {\rangle}}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
\fl{ Next}\al{31}{1}{ \.{\defeq}}\al{31}{2}{ Add}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{34}{1}{ \.{\defeq}}\al{34}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
