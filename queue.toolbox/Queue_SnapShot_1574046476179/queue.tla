...
(* --algorithm example
variables buffer = [i \in 1..BufSize |-> -1], write_ind = BufSize, read_ind = BufSize, last_read = 0
...
Write == /\ pc[0] = "Write"
         /\ IF write_ind <= Writes
               THEN /\ write_ind' = write_ind + 1
                    /\ buffer' = [buffer EXCEPT ![1 + (write_ind' % BufSize)] = write_ind']
...
\* Last modified Sun Nov 17 22:07:50 EST 2019 by samuelschetterer
